...
private:
	/** 输入映射 */
	UPROPERTY(EditAnywhere, meta=(AllowPrivateAccess), Category="Fantasy Engine|Configs|Input", DisplayName="Input Defines")
...
public:
	/** 输入映射 */
	UFUNCTION(BlueprintPure, Category="Fantasy Engine|Configs|Input", DisplayName="Input Defines",
