...
class FANTASTICENGINE_FRAMEWORK_API UFEGameInstance : public UPlatformGameInstance
{
	GENERATED_BODY()
...
public:
	 ...
	 * 全局类
	 */
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category="Fantastic Engine")
	UGameRoot* GameRoot;
...
private:
	 ...
	 */
	//UFUNCTION(BlueprintCallable, Category="Fantastic Engine", meta=( WorldContext="WorldContextObject"))
	static void InitGameRoot(const UObject* WorldContextObject);

	// /**
	//  * 获取全局类
	//  */
	// UFUNCTION(BlueprintCallable, Category="Fantastic Engine")
