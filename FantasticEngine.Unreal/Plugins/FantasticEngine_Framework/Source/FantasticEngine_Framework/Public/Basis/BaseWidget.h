...
struct FANTASTICENGINE_FRAMEWORK_API FWidgetConfig
{
	GENERATED_BODY()
...
class FANTASTICENGINE_FRAMEWORK_API UMiniWidget : public UUserWidget
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class FANTASTICENGINE_FRAMEWORK_API UBaseWidget : public UMiniWidget
{
	GENERATED_BODY()
