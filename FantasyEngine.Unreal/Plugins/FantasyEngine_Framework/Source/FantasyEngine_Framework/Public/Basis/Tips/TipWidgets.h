...
class FANTASYENGINE_FRAMEWORK_API UTipParam : public UWorldObject
{
	GENERATED_BODY()
};
 ...
 * 
 */
UCLASS(BlueprintType, Blueprintable, Category="Fantasy Engine")
class FANTASYENGINE_FRAMEWORK_API UTipWidgets : public UUserWidget
{
	GENERATED_BODY()
...
public:
	UFUNCTION(BlueprintPure, Category="Fantasy Engine|Tip Widgets")
...
public:
	UFUNCTION(BlueprintCallable, Category="Fantasy Engine|Tip Widgets", meta=(WorldContext="WorldContextObject"))
...
protected:
	UFUNCTION(BlueprintCallable, Category="Fantasy Engine|Tip Widgets")
