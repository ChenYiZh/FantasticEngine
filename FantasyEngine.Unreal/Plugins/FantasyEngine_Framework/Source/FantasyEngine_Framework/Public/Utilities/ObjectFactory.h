 ...
 */
UCLASS()
class FANTASYENGINE_FRAMEWORK_API UObjectFactory : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
//FANTASYENGINE_FRAMEWORK_API TMap<UClass*, UObject*>& SingletonPool();

FANTASYENGINE_FRAMEWORK_API void Destroy(UObject* Object);
