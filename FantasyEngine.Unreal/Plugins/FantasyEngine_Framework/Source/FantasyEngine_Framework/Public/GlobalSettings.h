...
struct FANTASYENGINE_FRAMEWORK_API FGlobalOption : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FANTASYENGINE_FRAMEWORK_API FGlobalOptions : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FANTASYENGINE_FRAMEWORK_API FGlobalSettings : public FTableRowBase
{
	GENERATED_BODY()
