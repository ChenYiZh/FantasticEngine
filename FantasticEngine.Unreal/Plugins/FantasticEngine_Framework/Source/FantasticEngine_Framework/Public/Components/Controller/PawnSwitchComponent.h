...
/** 角色切换类 */
UCLASS(Blueprintable, NotBlueprintType, ClassGroup="FantasticEngine", meta=(BlueprintSpawnableComponent))
class FANTASTICENGINE_FRAMEWORK_API UPawnSwitchComponent : public UActorComponent
{
	GENERATED_BODY()
