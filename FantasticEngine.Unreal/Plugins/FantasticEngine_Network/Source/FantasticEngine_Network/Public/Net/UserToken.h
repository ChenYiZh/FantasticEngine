 ...
 */
UCLASS()
class FANTASTICENGINE_NETWORK_API UUserToken : public UObject
{
	GENERATED_BODY()
	friend UFESocket;
...
private:
	/** 嵌套的Socket */
	UPROPERTY()
	TWeakObjectPtr<UFESocket> Socket;

public:
	/** 嵌套的Socket */
	UFUNCTION(BlueprintPure, Category="Fantastic Engine|Socket|User Token")
...
public:
	/** 消息Id，get 返回时会自动 +1 */
	UFUNCTION(BlueprintCallable, Category="Fantastic Engine|Socket")
