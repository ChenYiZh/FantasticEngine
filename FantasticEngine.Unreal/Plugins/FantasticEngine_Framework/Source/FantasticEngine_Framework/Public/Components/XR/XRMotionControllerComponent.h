...
UCLASS(Blueprintable, meta = (BlueprintSpawnableComponent), ClassGroup = "Fantastic Engine")
class FANTASTICENGINE_FRAMEWORK_API UXRMotionControllerComponent : public UMotionControllerComponent
{
	GENERATED_BODY()
