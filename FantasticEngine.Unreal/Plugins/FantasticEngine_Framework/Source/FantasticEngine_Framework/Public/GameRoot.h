...
class FANTASTICENGINE_FRAMEWORK_API UGameRoot : public UWorldObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Exec, Category="Fantastic Engine|Game Root",
...
public:
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category="Fantastic Engine|Game Root")
...
public:
	...
	UFUNCTION(BlueprintPure, Exec, Category="Fantastic Engine|Game Root", meta=(WorldContext="WorldContextObject"))
	static EGameRootState GetState(const UObject* WorldContextObject);

private:
	/** 配置信息 */
	UPROPERTY(VisibleInstanceOnly, Category="Fantastic Engine|Game Root|Configs")
	UGameDefines* GameDefines;


	/** 配置信息 */
	UPROPERTY(EditDefaultsOnly, Category="Fantastic Engine|Game Root|Configs")
	TSubclassOf<UGameDefines> GameDefinesClass = UGameDefines::StaticClass();

public:
	/** 全局配置信息，如果报黄可换 GameRootUtility 相应的接口 */
	UFUNCTION(Exec, BlueprintPure, Category="Fantastic Engine|Game Root",
		meta=(WorldContext="WorldContextObject", DeterminesOutputType=Class))
...
protected:
	/** 全局系统 */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Fantastic Engine|Game Root")
...
protected:
	/** 创建时调用大部分参数还未赋值 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category="Fantastic Engine|Game Root|Events")
	void OnCreate();
	/** 进入准备阶段事件 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category="Fantastic Engine|Game Root|Events")
	void OnReady();
...
public:
	...
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject"), Category="Fantastic Engine|Game Root|Cmd")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category="Fantastic Engine|Game Root|Cmd")
