 ...
 */
UCLASS()
class FANTASYENGINE_COMMON_API UImageUtility : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	/** 直接从字节流创建Texture */
	UFUNCTION(Exec, Category="Fantasy Engine|Image Utility")
	...
	UFUNCTION(BlueprintCallable, Exec, Category="Fantasy Engine|Image Utility")
	...
	UFUNCTION(Exec, BlueprintCallable, Category="Fantasy Engine|Image Utility",
