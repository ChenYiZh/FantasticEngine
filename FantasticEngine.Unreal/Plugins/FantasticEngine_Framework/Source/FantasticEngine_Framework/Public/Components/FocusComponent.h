...
/** 让父节点看向某个位置 */
UCLASS(NotBlueprintable, BlueprintType, ClassGroup="FantasticEngine", meta=(BlueprintSpawnableComponent))
class FANTASTICENGINE_FRAMEWORK_API UFocusComponent : public USceneComponent
{
	GENERATED_BODY()
