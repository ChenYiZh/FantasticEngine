...
class FANTASTICENGINE_FRAMEWORK_API UEventParam : public UWorldObject
{
	GENERATED_BODY()
};
...
USTRUCT()
struct FANTASTICENGINE_FRAMEWORK_API FEventMessagePair
{
	GENERATED_BODY()
...
USTRUCT()
struct FANTASTICENGINE_FRAMEWORK_API FEventCallbackArray
{
	GENERATED_BODY()
...
class FANTASTICENGINE_FRAMEWORK_API UEventSystem : public USystemBasis
{
	GENERATED_BODY()
