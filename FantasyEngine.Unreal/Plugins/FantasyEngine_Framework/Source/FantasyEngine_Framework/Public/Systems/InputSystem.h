...
class FANTASYENGINE_FRAMEWORK_API UInputSystem : public USystemBasis
{
	GENERATED_BODY()
...
public:
	UFUNCTION(BlueprintPure, Category="Fantasy Engine|Input System", meta=(WorldContext="WorldContextObject"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Fantasy Engine|Input System", meta=(WorldContext="WorldContextObject"))
