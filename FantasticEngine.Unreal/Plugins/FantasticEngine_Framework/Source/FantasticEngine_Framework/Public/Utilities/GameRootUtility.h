...
/** GameRoot 的拓展接口 */
UCLASS()
class FANTASTICENGINE_FRAMEWORK_API UGameRootUtility : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	/** 判断运行模式是否是Debug */
	UFUNCTION(BlueprintPure, Exec, Category="Fantastic Engine|Game Root Utility")
	...
	/** 判断是否可以执行初始化 */
	UFUNCTION(BlueprintPure, Exec, Category="Fantastic Engine|Game Root Utility", meta=(WorldContext="WorldContextObject"))
