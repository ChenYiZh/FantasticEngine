...
struct FANTASTICENGINE_FRAMEWORK_API FWidgetConfig : public FTableRowBase
{
	GENERATED_BODY()
...
class FANTASTICENGINE_FRAMEWORK_API UWidgetParam : public UWorldObject
{
	GENERATED_BODY()
};

UCLASS(BlueprintType)
class FANTASTICENGINE_FRAMEWORK_API UWidgetStackInfo : public UObject
{
	GENERATED_BODY()
...
USTRUCT()
struct FANTASTICENGINE_FRAMEWORK_API FWidgetEvent
{
	GENERATED_BODY()
...
USTRUCT()
struct FANTASTICENGINE_FRAMEWORK_API FWidgetStackEvent
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType)
class FANTASTICENGINE_FRAMEWORK_API UUIFactory : public USystemBasis
{
	GENERATED_BODY()
