using FantasyEngine.ScrptsEngine;
using System;
using System.IO;
...
using FantasyEngine.ScriptsEngine.Compilation.CSharp;
...
namespace FantasyEngine.ScriptsEngine.Compilation
{
    public class CSharpCompilation : ICompilation
    {
        ...
        public virtual ScriptsAnalysis Build(string projectPath, string outputPath, bool isDebug = false, string librariesPath = null)
        {
            ...
            //获取文件
            string[] scripts = Directory.GetFiles(FPath.GetFullPath(projectPath), "*.cs", SearchOption.AllDirectories);
