...
#include "FantasticEngineEditorSettings.generated.h"

/**
 * 
 */
UCLASS(config=FantasticEngineEditor, defaultconfig, meta=(DisplayName="Fantastic Engine Editor"))
class FANTASTICENGINE_FRAMEWORK_EDITOR_API UFantasticEngineEditorSettings : public UObject
{
	GENERATED_BODY()
