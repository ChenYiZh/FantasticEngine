 ...
 * 对象池子物体
 */
class FANTASTICENGINE_FRAMEWORK_API IPoolItem
{
	GENERATED_BODY()
...
class FANTASTICENGINE_FRAMEWORK_API UPoolItemHandle : public UWorldObject
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class FANTASTICENGINE_FRAMEWORK_API UObjectPooling : public UWorldObject
{
	GENERATED_BODY()
